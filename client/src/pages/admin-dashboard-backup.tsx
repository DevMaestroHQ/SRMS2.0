              ...
              <CardContent className="professional-card-content">
                <div className="table-professional">
                  <table className="w-full">
                    <thead>
                      <tr>
                        <th className="table-professional th">Student Name</th>
                        <th className="table-professional th">T.U. Registration</th>
                        <th className="table-professional th">Result</th>
                        <th className="table-professional th">Upload Date</th>
                        <th className="table-professional th">Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                      {records.map((record) => (
                        <tr key={record.id} className="table-professional tbody tr">
                          <td className="table-professional td">
                            <div className="flex items-center space-x-3">
